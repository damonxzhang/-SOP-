...
const MOCK_MACHINE_TYPES: MachineTypeInfo[] = [
...
const MOCK_RECORDS: ReplacementRecord[] = [
...
const MOCK_LOGS: ThresholdAdjustLog[] = [
...
const PreventiveMaintenance: React.FC = () => {
  ...
  const alertStatuses = useMemo<PartAlertStatus[]>(() => {
