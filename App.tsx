...
const App: React.FC = () => {
  ...
  useEffect(() => {
    fetch('/backend/auth/current-user', {
      headers: {
        Authorization: `Bearer ${localStorage.getItem('sop_token') || ''}`
      }
    })
      .then((r) => r.json())
      .then((res) => {
          ...
          <div className='max-w-7xl mx-auto px-4 flex justify-between items-center h-16'>
            <div className='flex items-center space-x-2'>
              ...
              <div className='flex flex-col'>
                ...
                <span className='text-[10px] font-black text-blue-600 uppercase tracking-tighter mt-0.5'>
                  V 1.2.20260320.001
                </span>
              </div>
            </div>
              ...
              <div className='relative' ref={userMenuRef}>
                <button
                  ...
                  <div className='relative'>
                    <img
                      className='h-9 w-9 rounded-full bg-slate-200 border-2 border-white shadow-sm'
                      src={
                        currentUser?.avatar || 'https://picsum.photos/100/100'
                      }
                      alt=''
                    />
                    ...
                    <button
                      onClick={() => {
                        ...
                        if (confirm('确定要退出登录吗？')) {
                          ...
                          localStorage.removeItem('sop_expire_at')
